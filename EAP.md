...
│   └── 1.3 Elaboração da EAP e cronograma
├── 2. Conteúdo
│   ├── 2.1 Redação dos textos (hero, serviços, equipe, rodapé)
│   ├── 2.2 Definição da equipe fictícia (nomes, cargos, fotos)
│   └── 2.3 Criação das ilustrações dos serviços
├── 3. Desenvolvimento (implementação)
│   ├── 3.1 Estrutura HTML semântica (cabeçalho, hero, seções, rodapé)
│   ├── 3.2 Estilização CSS (layout, responsividade, tema visual)
